Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"118 51 156 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"255 0 243 230" // Shadow color
		...
		"G_LightGrey"			"0 242 255 255" // Metal color in build/destroy menu
		...
		"G_HealthValue"			"0 242 255 255" // Health value color
		"G_Overheal"			"111 255 150 255" // Overhealed health value color
		"G_LowHealthValue"		"255 154 154 255" // Low health value color
		"G_AmmoClipValue"		"0 242 255 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"111 255 150 255" // Ammo in reserve value color
		"G_LowAmmo"				"255 154 154 255" // Low ammo color
		"G_MetalValue"			"0 242 255 255" // Metal color
		"G_MetalIcon"			"0 242 255 255" // Metal icon color
		"G_HeadsValue"			"235 220 51 255" // Heads value color
		"G_HeadsLabel"			"235 220 51 255" // Heads value icon color
		"G_KillstreakValue"		"255 255 255 255" // Killstreak value color
		"G_KillstreakIcon"		"255 255 255 255" // Killstreak icon color
		"G_StickyColor"					"255 186 55 255" // Stickybomb color
		"G_StickyIconColor"				"255 186 55 255" // Stickybomb icon color
		...
		"G_KillfeedBlue"			"83 218 242 255" // Killfeed blue text
		"G_KillfeedRed"				"255 105 88 255" // Killfeed red text
		...
		"G_MainMenuButton"			"228 228 228 255" // Main Menu button color
		"G_MainMenuButtonHover"		"118 51 156 255" // Main Menu hovered button color
		...
		"G_ButtonHoverBg"			"118 51 156 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"200 67 164 255" // Button selected bg color
		...
		"TFOrange"			"118 51 156 255" // Highlight color
		...
		"QualityColorrarity1"					"40 128 58 255" // IQC Genuine
		"QualityColorrarity2"					"141 131 75 255"
		"QualityColorrarity3"					"204 204 250 255"
		"QualityColorrarity4"					"128 43 187 255" // IQC Unusual
		"QualityColorVintage"					"68 117 202 255" // IQC Vintage
		"QualityColorUnique"					"255 215 0 255" // IQC Unique
		"QualityColorCommunity"					"85 210 11 255" // IQC Community
		"QualityColorDeveloper"					"192 4 137 255" // IQC Valve
		"QualityColorSelfMade"					"85 210 11 255" // IQC Community
		"QualityColorCustomized"				"71 98 145 255"
		"QualityColorStrange"					"255 104 20 255" // IQC Strange
		"QualityColorCompleted"					"134 80 172 255"
		"QualityColorHaunted"					"41 202 140 255" // IQC Haunted
		"QualityColorCollectors"				"210 29 29 255" // IQC Collectors
		"QualityColorPaintkitWeapon"			"250 250 250 255" // IQC PaintkitWeapon
		
		"DimmQualityColorNormal"				"178 178 178 100" // Dimm IQC Normal
		"DimmQualityColorrarity1"				"40 128 58 100" // Dimm IQC Genuine
		"DimmQualityColorrarity2"				"141 131 75 100"
		"DimmQualityColorrarity3"				"204 204 250 100"
		"DimmQualityColorrarity4"				"128 43 187 100" // Dimm IQC Unusual
		"DimmQualityColorVintage"				"68 117 202 100" // Dimm IQC Vintage
		"DimmQualityColorUnique"				"255 215 0 100" // Dimm IQC Unique
		"DimmQualityColorCommunity"				"85 210 11 100" // Dimm IQC Community
		"DimmQualityColorDeveloper"				"192 4 137 100" // Dimm IQC Valve
		"DimmQualityColorSelfMade"				"85 210 11 100" // Dimm IQC Community
		"DimmQualityColorCustomized"			"71 98 145 100"
		"DimmQualityColorStrange"				"255 104 20 100" // Dimm IQC Strange
		"DimmQualityColorCompleted"				"134 80 172 100"
		"DimmQualityColorHaunted"				"41 202 140 100" // Dimm IQC Haunted
		"DimmQualityColorCollectors"			"210 29 29 100" // Dimm IQC Collectors
	...
	BaseSettings
	{
		...
		Slider.NobColor				"118 51 156 255" // Highlight color
